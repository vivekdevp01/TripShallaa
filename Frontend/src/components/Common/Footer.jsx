      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="mailto:info@tripShaala.com" className="hover:text-orange-500 transition-colors">
                info@tripShaala.com
              </a>
            </li>
            <li>Office</li>
            <li>
              <a href="tel:+91565656" className="hover:text-orange-500 transition-colors">
                +91 56565656
              </a>
            </li>
            <li>
              <a href="tel:+9169696969" className="hover:text-orange-500 transition-colors">
                +91 6969696969
              </a>
            </li>
            <li>
              <a href="mailto:tripShaala@gmail.com" className="hover:text-orange-500 transition-colors">
                ...
                <div className="container mx-auto px-4 pt-3">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="mb-4 md:mb-0">
                            <p>&copy; {new Date().getFullYear()} TripShallaa. All Rights Reserved.</p>
                        </div>
